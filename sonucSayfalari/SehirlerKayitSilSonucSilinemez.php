...
<div id="SonucSayfalariAlaniKapsayicisi">
	...
	<div class="SonucSayfalariIcerikAlaniKapsayicisi">
		Sistem tarafından kullanılmakta olan bir kayıt silinemez. Lütfen öncelikle ilgili kaydın kullanıldığı tüm alanları farklı bir kayıt ile güncelledikten sonra tekrar deneyiniz.<br />Şehirler sayfasına dönmek için lütfen <a href="http://www.<?php echo SITEDOMAINI.SITEDIZINI; ?>/index.php?S=0&SS=35" target="_top">buraya tıklayınız</a>.<br />Ana sayfaya dönmek için lütfen <a href="http://www.<?php echo SITEDOMAINI.SITEDIZINI; ?>/index.php?S=0&SS=1" target="_top">buraya tıklayınız</a>.
	</div>
</div>
<?php }else{
