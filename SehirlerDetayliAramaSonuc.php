<? if(isset($_SESSION["Yonetici"])){
	...
	$GelenSehirAdiIcerigi		=	HarfliVeSayiliIcerikleriFiltrele(html_entity_decode(urldecode($_REQUEST["SehirAdi"]), ENT_QUOTES, "UTF-8"));
	
	if($GelenUlkesiIcerigi!=""){
		if($GelenUlkesiIcerigi!="Tüm Ülkeler"){
			$InnerliSorguKosulu		=	"WHERE sehirler.UlkeIDsi='".$GelenUlkesiIcerigi."'";
			$DuzSorguKosulu			=	"WHERE UlkeIDsi='".$GelenUlkesiIcerigi."'";
		}else{
			$InnerliSorguKosulu		=	"";
			$DuzSorguKosulu			=	"";
		}
	...
	if($GelenSehirAdiIcerigi!=""){
		if($InnerliSorguKosulu!=""){
			$InnerliSorguKosulu		.=	" AND sehirler.SehirAdi LIKE '%".$GelenSehirAdiIcerigi."%'";
			$DuzSorguKosulu			.=	" AND SehirAdi LIKE '%".$GelenSehirAdiIcerigi."%'";
		}else{
			$InnerliSorguKosulu		.=	"WHERE sehirler.SehirAdi LIKE '%".$GelenSehirAdiIcerigi."%'";
			$DuzSorguKosulu			.=	"WHERE SehirAdi LIKE '%".$GelenSehirAdiIcerigi."%'";
		}
	}
	
	$ToplamKayitSayisiSorgusu				=	$VeritabaniBaglantisi->query("SELECT * FROM sehirler $DuzSorguKosulu");
...
<div id="ListelemeAlaniKapsayicisi">
	<div class="SayfaIciBaslikAlanlariKapsayicisi">
		<a href="http://www.<?php echo SITEDOMAINI.SITEDIZINI; ?>/index.php?S=0&SS=35" target="_top">Şehirler</a> > Detaylı Arama Sonuç
	...
	<div class="ListelemeAlaniIciTabloAlaniKapsayicisi">
		<table class="ListelemeAlaniIciTablosu" align="center" cellpadding="0" cellspacing="0">
			...
			<tbody>
			<?php
			$SehirlerSorgusu				=	$VeritabaniBaglantisi->query("SELECT sehirler.ID, sehirler.UlkeIDsi, sehirler.SehirAdi, sehirler.EklenmeTarihi, sehirler.SiraNumarasi, ulkeler.UlkeAdi FROM sehirler INNER JOIN ulkeler ON sehirler.UlkeIDsi = ulkeler.ID $InnerliSorguKosulu ORDER BY ulkeler.SiraNumarasi ASC, sehirler.SiraNumarasi ASC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SiteAyarlariKaydiSehirlerSayfasiListelemeLimiti");
...
<div id="SayfalamaAlaniKapsayicisi">
	...
	<div class="SayfalamaAlaniIciNumaralandirmaAlaniKapsayicisi">
		<?php
		if($GelenSayfalama>1){
			echo 	"<span class=\"Pasif\"><a href=\"http://www.".SITEDOMAINI.SITEDIZINI."/index.php?S=0&SS=38&Sayfalama=1&Ulkesi=".urlencode($GelenUlkesiIcerigi)."&SehirAdi=".urlencode($GelenSehirAdiIcerigi)."\" target=\"_top\"><img src=\"Resimler/IconSayfalamaIlk.png\" width=\"10\" height=\"10\" title=\"\" alt=\"\"></a></span>";
			$SayfalamaIcinSayfaDegeriniBirGeriAl	=	$GelenSayfalama-1;
			echo 	"<span class=\"Pasif\"><a href=\"http://www.".SITEDOMAINI.SITEDIZINI."/index.php?S=0&SS=38&Sayfalama=".$SayfalamaIcinSayfaDegeriniBirGeriAl."&Ulkesi=".urlencode($GelenUlkesiIcerigi)."&SehirAdi=".urlencode($GelenSehirAdiIcerigi)."\" target=\"_top\"><img src=\"Resimler/IconSayfalamaBirGeri.png\" width=\"6\" height=\"10\" title=\"\" alt=\"\"></a></span>";
		}
		...
		for($SayfalamaIcinSayfaIndexDegeri=$GelenSayfalama-$SayfalamaIcinSolveSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri<=$GelenSayfalama+$SayfalamaIcinSolveSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++){
			if(($SayfalamaIcinSayfaIndexDegeri>0) and ($SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi)){
				if($SayfalamaIcinSayfaIndexDegeri==$GelenSayfalama){
					...
					echo 	"<span class=\"Pasif\"><a href=\"http://www.".SITEDOMAINI.SITEDIZINI."/index.php?S=0&SS=38&Sayfalama=".$SayfalamaIcinSayfaIndexDegeri."&Ulkesi=".urlencode($GelenUlkesiIcerigi)."&SehirAdi=".urlencode($GelenSehirAdiIcerigi)."\" target=\"_top\">".$SayfalamaIcinSayfaIndexDegeri."</a></span>";
				}
			}
		}
		...
		if($GelenSayfalama!=$BulunanSayfaSayisi){
			...
			echo 	"<span class=\"Pasif\"><a href=\"http://www.".SITEDOMAINI.SITEDIZINI."/index.php?S=0&SS=38&Sayfalama=".$SayfalamaIcinSayfaDegeriniBirIleriAl."&Ulkesi=".urlencode($GelenUlkesiIcerigi)."&SehirAdi=".urlencode($GelenSehirAdiIcerigi)."\" target=\"_top\"><img src=\"Resimler/IconSayfalamaBirIleri.png\" width=\"6\" height=\"10\" title=\"\" alt=\"\"></a></span>";
			echo 	"<span class=\"Pasif\"><a href=\"http://www.".SITEDOMAINI.SITEDIZINI."/index.php?S=0&SS=38&Sayfalama=".$BulunanSayfaSayisi."&Ulkesi=".urlencode($GelenUlkesiIcerigi)."&SehirAdi=".urlencode($GelenSehirAdiIcerigi)."\" target=\"_top\"><img src=\"Resimler/IconSayfalamaSon.png\" width=\"10\" height=\"10\" title=\"\" alt=\"\"></a></span>";			
		}
		?>
	</div>
</div>
